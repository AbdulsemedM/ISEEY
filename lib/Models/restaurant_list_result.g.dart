...
_$RestaurantListResultImpl _$$RestaurantListResultImplFromJson(
    ...
    _$RestaurantListResultImpl(
      ...
      reviewsCount: json['restaurantReviewCount'] as int?,
      ...
      stateExists: json['stateExists'] as int?,
      cityExists: json['cityExists'] as int?,
      countryDetails: json['countryDetails'] as int?,
